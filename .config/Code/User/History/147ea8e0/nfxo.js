...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const color1Input = document.getElementById('color1'); // First color picker input
    const color2Input = document.getElementById('color2'); // Second color picker input
    const mixedColorDiv = document.getElementById('mixedColor'); // Div to display the mixed color
    const hexCodeParagraph = document.getElementById('hexCode'); // Paragraph to display the hex code
    const pageHeader = document.getElementById('pageHeader'); // The header element
    const pageFooter = document.getElementById('pageFooter'); // The footer element
